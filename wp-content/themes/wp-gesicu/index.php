...
require_once('components/navbar.inc.php'); ?>
    ...
    <header>
        ...
        <?php require_once('inc/carousel.inc.php'); ?>
        <!-- Intro -->
            ...
            <div class="card-body white-text rgba-black-light text-center pt-5 pb-4">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="font-weight-bold mb-4">C.N.A SERVELEC</h1>
                        <p class="lead mb-4">Con un peso en la ecnom&iacute;a...Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ad impedit corporis ratione facere?
    ...
    <main>
        <div class="container">
            ...
            <section class="text-center">
                ...
                <!--Section heading-->
                <h1 class="h2 font-weight-bold my-4"><?php _e( 'Recent Posts' ); ?></h1>
                <!--Grid row-->
                <div class="row wow fadeIn">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <a href="<?php echo get_permalink() ?>" class="btn btn-info btn-rounded btn-md"><?php _e( 'Read more' ); ?></a>
                    </div>
                    <!--Grid column-->
