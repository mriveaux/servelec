 ...
 */
?>
<div id="footer__credits" class="footer__credits footer-copyright" <?php czr_fn_echo('element_attributes') ?>>
...
<!--      <span class="czr-wp-powered"><span class="czr-wp-powered-text">--><?php //_e( 'Powered by', 'customizr') ?><!--&nbsp;</span>-->
<!--          <a class="czr-wp-powered-link" title="--><?php //_e( 'Powered by WordPress', 'customizr' ) ?><!--" href="--><?php //echo esc_url( __( 'https://wordpress.org/', 'customizr' ) ); ?><!--" target="_blank" rel="noopener noreferrer">WP</a>-->
<!--        &nbsp;&ndash;&nbsp;-->
<!--      </span>-->
        <span class="czr-designer-text"><?php printf( __('Desarrollado por %s', 'customizr'), sprintf( '<a class="czr-designer-link" href="%1$s" title="%2$s">%2$s</a>', esc_url( 'https://www.linkedin.com/in/mdriveaux/'), __('Ing. Miguel D&iacute;az Riveaux') ) ); ?>
        </span>
